...
TStife24= array[0..239] of TBGR; //240×3
...
{Var
  le: integer;
BEGIN //Works in Double Buffing not in single ParxLeft1 as pointer
...
BEGIN //Vram stands away from linear & mappable memmories
P1 := linearMemAlign(1280, 256); // 
P2 := vramMemAlign(16384, 16); //8192 was tempting raised on Vic20  
P3 := mappableAlloc(512000); //

BWash3D := vramMemAlign(400*240*3*30*2, $100); //  L&R 24bit colour 30 frames 
END;
