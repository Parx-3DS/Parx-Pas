...
u8* GetSrcL(int index);external;
u8* GetSrcR(int index);external;
u8* GetSrcB(int index);external;

void* SetSrcL(int index, u8* screen);external;
void* SetSrcR(int index, u8* screen);external;
void* SetSrcB(int index, u8* screen);external;
