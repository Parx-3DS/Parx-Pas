...
//natural, ordinal, bytes, Bools & other delimtiers of lesser propaganda's 
 ColourExt = record
 case word of
  0 : (N : TRGB16);
  1 : (O : BIN16);
  2 : (Bytes: Byte16);   
  3 : (Bools: BoolBit16);  
  4 : (c565 : TRGB565); //Colour delimated mode 2
  5 : (cA1 : TRGB5_A1); //Colour delimated mode 3
  6 : (c4 : TRGBA4); //Colour delimated mode 4
 end; 
...
//Parx3D16 = Class(Parx3DX)
var GSP_16bit_OES: integer; //defaults too GSP_RGBA4_OES
